...
first_layer = pygame.image.load('Images/background/first_layer.png').convert_alpha()
first_layer = pygame.transform.scale(first_layer, (800, 640))

second_layer = pygame.image.load('Images/background/2d_layer.png').convert_alpha()
second_layer = pygame.transform.scale(second_layer, (800, 640))

last_layer = pygame.image.load('Images/background/last_layer.png').convert_alpha()
last_layer = pygame.transform.scale(last_layer, (800, 640))




menu_bg = pygame.image.load('Images/menu_background/background_menu.png').convert_alpha()
menu_bg = pygame.transform.scale(menu_bg, (800, 640))


missile_img = pygame.image.load('Images/roof enemy/grenade.png').convert_alpha()


img_health_item = pygame.image.load('Images/Icons/health_icon.png').convert()
img_health_item = pygame.transform.scale(img_health_item, (img_health_item.get_width() * 4 , img_health_item .get_height() * 4))

health_icon_images = []
for i in range(6):
    img = pygame.image.load(f'Images/Icons/{i}.png').convert()
    img = pygame.transform.scale(img, (img.get_width() * 3, img.get_height() * 3))
    health_icon_images.append(img)


img_robot_saved = pygame.image.load('Images/Icons/green_head.png').convert()
img_robot_saved = pygame.transform.scale(img_robot_saved, (img_robot_saved.get_width() * 4 , img_robot_saved .get_height() * 4))

slash = pygame.image.load('Images/Icons/slash.png').convert()
slash = pygame.transform.scale(slash, (slash.get_width() * 3 , slash .get_height() *3))

img_ammo_item = pygame.image.load("Images/Icons/ammo_icon.png").convert_alpha()